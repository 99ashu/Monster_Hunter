...
def monsterHunter():
    ...
    titleFont1 = pygame.font.Font("assets/Abrushow.ttf", 80)
    ...
    titleFont2 = pygame.font.Font("assets/Abrushow2.otf", 50)
    ...
    class Game():
        ...
        def __init__(self, player, monsterGroup):
            ...
            self.nextLevelSound = pygame.mixer.Sound("assets/next_level.wav")
            self.nextLevelSound.set_volume(0.2)

            self.font = pygame.font.Font("assets/Celosia.otf", 28)

            blueImage = pygame.image.load("assets/blue_monster.png")
            greenImage = pygame.image.load("assets/green_monster.png")
            purpleImage = pygame.image.load("assets/purple_monster.png")
            yellowImage = pygame.image.load("assets/yellow_monster.png")
